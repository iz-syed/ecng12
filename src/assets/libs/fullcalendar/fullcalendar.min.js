        ...
        var r = n(2),
            ...
            v = function (t) {
                ...
                return r.__extends(e, t), e.prototype.end = function () {
                    ...
                    var n, i;
                    var dragItem=  $(t.target).hasClass('drag-item')?t.target:null;
                    this.opt("droppable") && (n = o((e ? e.item : null) || dragItem), i = this.opt("dropAccept"), (o.isFunction(i) ? i.call(n[0], n) : n.is(i)) && (this.isDragging || this.listenToExternalDrag(n, t, e)))
        ...
        var i = n(3),
            ...
            s = function () {
                ...
                return t.prototype.show = function () {
                    ...
                    if (this.el && !i(t.target).closest(this.el).length) {
                        var sel = this;
                        setTimeout(function () {
                            sel.hide()
                        }, 200)
